...
/***/ function(module, exports, __webpack_require__) {
	...
	var Center = __webpack_require__(182);
	var Btn = __webpack_require__(183);

	ReactDOM.render(React.createElement(Header, null), document.getElementById('d-header'));
	ReactDOM.render(React.createElement(Center, null), document.getElementById('d-center'));
	ReactDOM.render(React.createElement(Btn, null), document.getElementById('d-btn'));
	...
	var Header = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: "detail-header", id: "detail-header" },
	            React.createElement(
	                "div",
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("em", { className: "bk" })
	                ),
	                React.createElement(
	                    "span",
	                    { className: "tit" },
	                ...
	                React.createElement(
	                    "a",
	                    { href: "index.html" },
	                    React.createElement("em", { className: "hm" })
	                ),
	                React.createElement("em", { className: "sr unsee" })
	            ),
	            React.createElement(
	                "section",
	                { id: "d-banner", className: "banner" },
	                React.createElement(
	                    "div",
	                    { className: "box" },
	                    React.createElement("img", { src: "img/d-banner.png" })
	                )
	            ),
	            React.createElement(
	                "div",
	                ...
	                React.createElement(
	                    "section",
	                    { className: "pri-item flex" },
	                    React.createElement(
	                        "div",
	                        { className: "pri flex-item" },
	                        "￥128"
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "had-buy-num flex-item" },
	                        "1359人购买过"
	                    )
	                ),
	                React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Center = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: "detail-center", id: "detail-center" },
	            React.createElement(
	                "section",
	                { className: "authority" },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "li",
	                        { className: "zp flex-item" },
	                        React.createElement("em", null),
	                        "正品保证"
	                    ),
	                    React.createElement(
	                        "li",
	                        { className: "th flex-item" },
	                        React.createElement("em", null),
	                        "60天退货"
	                    ),
	                    React.createElement(
	                        "li",
	                        { className: "gf flex-item" },
	                        React.createElement("em", null),
	                        "官方授权"
	                    ),
	                    React.createElement(
	                        "li",
	                        { className: "fh flex-item" },
	                        React.createElement("em", null),
	                        "闪电发货"
	                    )
	                )
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "head" },
	                            React.createElement("img", { src: "img/d-head.png" })
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: "pj flex-item" },
	                            React.createElement(
	                                "div",
	                                { className: "name-time flex" },
	                                React.createElement(
	                                    "span",
	                                    { className: "name flex-item" },
	                                    "摩尔"
	                                ),
	                                React.createElement(
	                                    "span",
	                                    { className: "time flex-item" },
	                                    "2016-05-09 20:19"
	                                )
	                            ),
	                            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(33);
	var Tanc = __webpack_require__(184);
	var Mask = __webpack_require__(188);
	var WordTip = __webpack_require__(189);
	var store = __webpack_require__(185);
	var Btn = React.createClass({
	    displayName: 'Btn',

	    tancShow: function tancShow() {
	        ReactDOM.render(React.createElement(Tanc, null), document.getElementById('d-tanc'));
	        ReactDOM.render(React.createElement(Mask, null), document.getElementById('d-mask'));
	        store.dispatch({ type: 'showTanc' });
	    },
	    render: function render() {
	        return React.createElement(
	            'section',
	            { id: 'buy-btn', className: 'buy-btn flex' },
	            React.createElement(
	                'div',
	                { className: 'add flex-item', onClick: this.tancShow },
	                '加入购物车'
	            ),
	            React.createElement(
	                'div',
	                { className: 'fast-buy flex-item', href: 'buy_car.html', onClick: this.tancShow },
	                '立即购买'
	            ),
	            React.createElement(
	                'a',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var store = __webpack_require__(185);
	var watch = __webpack_require__(187);
	var Tanc = React.createClass({
	    ...
	    closeTanc: function closeTanc() {
	        store.dispatch({ type: 'closeTanc' });
	    },
	    render: function render() {
	        return React.createElement(
	            'section',
	            { id: 'tc-choice', className: 'tc-choice', style: { display: store.getState() } },
	            React.createElement(
	                'div',
	                { className: 'pro flex' },
	                React.createElement(
	                    'div',
	                    { className: 'pic' },
	                    React.createElement('img', { src: 'img/d-tc-pro.png' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'info flex-item' },
	                    React.createElement(
	                        'h3',
	                        null,
	                        '美肌系列'
	            ...
	            React.createElement(
	                'div',
	                { className: 'b-num flex' },
	                React.createElement(
	                    'div',
	                    { className: 'tit flex-item' },
	                    '购买数量'
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'numc flex-item' },
	                    React.createElement(
	                        'em',
	                        { className: 'emless' },
	                        '-'
	                    ),
	                    React.createElement('input', { value: '2', type: 'text' }),
	                    React.createElement(
	                        'em',
	                        { className: 'emmore on' },
	                        '+'
	            ...
	            React.createElement('div', { className: 'close', onClick: this.closeTanc })
	        );
	    }
	});
	module.exports = Tanc;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(168);
	var counter = __webpack_require__(186);
	var createStore = Redux.createStore;
	var store = createStore(counter); //存储到store里面
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mask = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', { className: 'mask', id: 'mask', onClick: this.hideAside, style: { display: store.getState() } });
	  }
	});
	module.exports = Mask;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WordTip = React.createClass({
		...
		render: function render() {
			var t = store.getState();
			return React.createElement('div', { className: 'word-tip', style: { display: this.state.show } });
		}
	});
